                ...
                <div class="col-lg-3">
                    <div class="ibox ">
                        <div class="ibox-title">
                            ...
                            <h5>Today leave Employees</h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">2.00000</h1>
                ...
                <div class="col-lg-3">
                    <div class="ibox ">
                        <div class="ibox-title">
                            ...
                            <h5>Leave Employees</h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">8.0000</h1>
                            <div class="stat-percent font-bold text-danger">1.5% <i class="fa fa-level-down"></i></div>
                            <small>In first Year</small>
                        </div>
                    </div>
                </div>
            </div>
