                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        <form
                                            ...
                                            <div
                                                ...
                                                <div class="p-4">
                                                    <label
                                                        class="font-normal">Change Profile photo</label>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="form-group">
                                                        <label
                                                            class="col-sm-2 control-label">Company
                                                            name</label>
                                                        <div
                                                            class="col-sm-10">
                                                            <input
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="form-group">
                                                        <label
                                                            class="col-sm-2 control-label">Work
                                                            number</label>
                                                        <div
                                                            class="col-sm-10">
                                                            <input
                                                    ...
                                                    <div
                                                        class="form-group">
                                                        <label
                                                            class="col-sm-2 control-label">E-mail
                                                            address</label>
                                                        <div
                                                            class="col-sm-10">
                                                            <input
