                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" id="tab-1" class="tab-pane active">
                                                        <div class="ibox-tools">
                                                            <a href="{{route('expense.add_daily_expense')}}" class="btn btn-w-m btn-success">Add Daily Expenses</a>
                                                        </div>
                                                        <div class="panel-body">
                                                    ...
                                                    <div role="tabpanel" id="tab-3" class="tab-pane">
                                                        <div class="ibox-tools">
                                                            <a href="{{route('expense.add_payroll')}}" class="btn btn-w-m btn-success">Add Payroll</a>
                                                        </div>
                                                        <div class="panel-body">
                                                            <div class="table-responsive">
                                                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                                                    ...
                                                                    <tr class="gradeX">
                                                                        ...
                                                                        <td>0</td>
                                                                        <td>50,000</td>
                                                                        <td><a href="{{route('expense.payroll_detail')}}">View Details</a></td>
                                                                    </tr>
                                                                    <tr class="gradeC">
                                                                        <td>001</td>
                                                                        <td>Maria Chughtai</td>
